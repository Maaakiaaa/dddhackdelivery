...
export default function GameTimer({ className = "" }: GameTimerProps) {
  ...
  return (
    <div
      ...
      className={`absolute z-20 min-w-28 rounded-lg border border-white/10 bg-black/55 px-4 py-3 text-right text-stone-100 shadow-[0_12px_32px_rgba(0,0,0,0.35)] backdrop-blur-sm ${className}`}
    >
